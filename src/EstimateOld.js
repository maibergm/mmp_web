...
function EstimateOld() {
  ...
  function modalTester() {
    ...
    return (
      <div className = "bed-picker-modal">
        <Modal show={show} onHide={handleClose}>
        <Modal.Header>
          <h4 className="text-center"> What is the size of the bed? </h4>
        </Modal.Header>
          <Modal.Body>
            ...
            <h4 className="text-center"> What parts are being collected? </h4>
            <div className = " bed-picker">
              <button
            ...
            <button
              className="form-control ok-button "
        ...
        <h4 className="d-flex justify-content-center">Bedroom</h4>
         <div className="inventory-list">
           <div className = "mb-3">
             ...
             <button
               className={`form-control  ${ bedPartModal ? 'selected' : ''}`}
               type="button"
               onClick={handleShow} >
               {bedModal + ' ' + bedPartModal}
             </button>
              <button className = "form-control" type="button" >1</button>
            </div>
             {modalTester()}
           </div>
           {bedroomItems.map((item, index) => (
             <div className = "item-button-group">
                <button className= "form-control" type="button" >Couch</button>
              <button className = "form-control" type="button" >1</button>
            </div>
           ))}
         </div>
